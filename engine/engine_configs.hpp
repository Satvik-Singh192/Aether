...
constexpr float PHSYICS_CONTACT_SLOP=0.02f; //if contacts difference less than this then new contact will be treated the same as old contact, called in file physics world::match_manifolds()
